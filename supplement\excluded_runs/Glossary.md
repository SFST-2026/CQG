...
I use the following symbols and conventions throughout the addendum/supplement.
...
- **Variant A / Variant B** (insertion semantics) — 
 ...
 Variant B (exploratory): inertial + gravitational‑source insertion — I also add the same correction to dm/dr; I treat Variant B as a sensitivity check only and flag a conceptual double‑counting risk.
