# EOS / Prior Sensitivity — Minimum reviewer-facing checks
...
This supplement documents **minimal, high-leverage robustness checks** expected by reviewers when headline neutron-star / GW-target numbers depend on modelling choices.
