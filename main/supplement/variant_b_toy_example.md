...
## Purpose
We provide a minimal, formal demonstration of why inserting the same vacuum‑induced inertial coefficient into both the inertial term and the gravitational source can amount to double counting, and I state clear criteria for when Variant‑B is a justified exploratory test.
